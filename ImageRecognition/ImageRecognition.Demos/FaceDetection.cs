...
namespace ImageRecognition.Demos
{
    ...
    {
        public static IImage Tagging(string imagePath,string faceCudaCascadeFileName,string eyeCudaCascadeFileName, out long detectionTime)
        {
            IImage image = new UMat(imagePath, ImreadModes.Color); //UMat version
            
            List<Rectangle> faces = new List<Rectangle>();
            List<Rectangle> eyes = new List<Rectangle>();

            Detect(
              image, faceCudaCascadeFileName, eyeCudaCascadeFileName,
               faces, eyes,
               out detectionTime);
